  ...
  return (
    <View className="flex-1 bg-canvas dark:bg-canvas-dark">
      <View className="flex-row justify-between items-center px-6 pt-14 pb-5">
        ...
        <Text className="text-ink-muted dark:text-ink-muted-dark text-[10px] tracking-[4px]">EDIT EXERCISE</Text>
        <View className="w-6" />
      </View>
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 40 }}>
        ...
        <TextInput
          className="bg-surface dark:bg-surface-dark rounded px-4 py-4 text-ink dark:text-ink-dark text-lg font-bold tracking-tight mb-6"
